        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="order-2">
            ...
            <p className="text-white/80">
              To be recognized as global leaders in software development,
              proactively anticipating and responding to market demands. We aim
              to pioneer emerging technologies, set standards of excellence, and
              be the preferred partner for companies seeking advanced, reliable
              tech solutions.
            </p>
          </div>
          <div className="w-full xl:flex-1 flex justify-center">
